...
def load_pretrained_model(model_path: str = os.path.join(PROJECT_ROOT, "models", "minirocket_pretrained.pkl")) -> dict:
    """
...
def save_model_universal(
    rocket: MiniRocketMultivariate,
    classifier,
    save_path: str = os.path.join(PROJECT_ROOT, "models", "minirocket_universal.pkl")
) -> None:
    """
...
def main():
    ...
    print("\n2. 加载预训练模型...")
    pretrained_model = load_pretrained_model(os.path.join(PROJECT_ROOT, "models", "minirocket_pretrained.pkl"))
    ...
    print("\n5. 模型保存阶段...")
    save_model_universal(rocket, classifier, os.path.join(PROJECT_ROOT, "models", "minirocket_universal.pkl"))
